...
container.innerHTML = '<a title="click to watch ' + mvs[randomAd].title + ' right meow!" href="' + mvs[randomAd].url + '" target="_blank"><img src="' + mvs[randomAd].img + '" alt="' + mvs[randomAd].title + ' ad screenshot">' + '</a>';
